...
type UserManagementClient interface {
	...
	GetUsers(ctx context.Context, in *EmptyParams, opts ...grpc.CallOption) (*UsersResponse, error)
	DeleteUser(ctx context.Context, in *UserEmail, opts ...grpc.CallOption) (*UserResponse, error)
}
...
func (c *userManagementClient) CreateUser(ctx context.Context, in *User, opts ...grpc.CallOption) (*UserResponse, error) {
...
func (c *userManagementClient) GetUsers(ctx context.Context, in *EmptyParams, opts ...grpc.CallOption) (*UsersResponse, error) {
...
func (c *userManagementClient) DeleteUser(ctx context.Context, in *UserEmail, opts ...grpc.CallOption) (*UserResponse, error) {
	out := new(UserResponse)
...
type UserManagementServer interface {
	...
	GetUsers(context.Context, *EmptyParams) (*UsersResponse, error)
	DeleteUser(context.Context, *UserEmail) (*UserResponse, error)
...
func (UnimplementedUserManagementServer) CreateUser(context.Context, *User) (*UserResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateUser not implemented")
}
func (UnimplementedUserManagementServer) GetUsers(context.Context, *EmptyParams) (*UsersResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetUsers not implemented")
}
func (UnimplementedUserManagementServer) DeleteUser(context.Context, *UserEmail) (*UserResponse, error) {
...
func _UserManagement_GetUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserManagementServer).GetUsers(ctx, req.(*EmptyParams))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _UserManagement_DeleteUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserManagementServer).DeleteUser(ctx, req.(*UserEmail))
	}
	return interceptor(ctx, in, info, handler)
}
